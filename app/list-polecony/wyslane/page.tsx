/**
 * List Polecony Wysłane Page
 *
 * Wyświetla listę klientów dla których list polecony został już wygenerowany
 * (mają flagę [LIST_POLECONY]true w note)
 */
...
async function getWyslaneClients() {
  ...
  console.log(`[ListPolecony Wysłane] Klientów z wysłanym listem: ${wyslaneClients.length}`);
  return wyslaneClients;
}

export default async function ListPoleconyWyslanePage() {
  const clients = await getWyslaneClients();
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-gray-600">
              Klienci z wygenerowanym listem poleconym
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-blue-900">
                  Wysłane listy polecone
                </h3>
                <div className="mt-2 text-sm text-blue-700">
                  Dla tych klientów list polecony został już wygenerowany. Dokumenty zostały pobrane i są gotowe do wysyłki.
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Tabela */}
          <ListPoleconyTable clients={clients} hideGenerateButton={false} regenerateMode={true} showSentDate={true} />
