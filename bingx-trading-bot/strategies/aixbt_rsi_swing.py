"""
AIXBT RSI Swing Strategy - CORRECTED RSI
...
class AIXBTRSISwingStrategy(BaseStrategy):
    """AIXBT RSI Mean Reversion Strategy with Limit Orders"""

    def __init__(self, config: Dict[str, Any], symbol: str = 'AIXBT'):
        super().__init__('aixbt_rsi_swing', config, symbol)
