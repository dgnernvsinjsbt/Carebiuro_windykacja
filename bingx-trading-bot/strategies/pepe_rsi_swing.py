"""
PEPE RSI Swing Strategy - CORRECTED RSI
...
class PEPERSISwingStrategy(BaseStrategy):
    """1000PEPE RSI Mean Reversion Strategy with Limit Orders"""

    def __init__(self, config: Dict[str, Any], symbol: str = '1000PEPE'):
        super().__init__('pepe_rsi_swing', config, symbol)
