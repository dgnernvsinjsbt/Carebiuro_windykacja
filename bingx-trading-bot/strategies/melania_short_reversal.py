"""
MELANIA SHORT Reversal Strategy - OPTIMIZED

Individual Performance (Jun-Dec 2025, 15m candles, 5% risk/trade):
- Contribution to Portfolio: $664,328 (12.8% of total)
- Trades: 45
- Profitable Months: 6/7
- Best Trade: +$574,827 (Dec 2)
...
class MelaniaShortReversal(BaseStrategy):
    """MELANIA SHORT Reversal Strategy with Limit Orders"""

    def __init__(self, config: Dict[str, Any], symbol: str = 'MELANIA-USDT'):
        super().__init__('melania_short_reversal', config, symbol)

        # Strategy parameters (from backtest optimization)
        self.rsi_trigger = 72  # Slightly higher threshold for MELANIA
        self.lookback = 5
