"""
XLM RSI Swing Strategy - CORRECTED RSI
...
Entry: RSI(14) crosses above 30 (LONG) or below 75 (SHORT)
Limit: 1.5% offset from signal price (wait max 5 bars)
Exit: 1.0x ATR stop loss, 1.5x ATR take profit, or RSI reversal
"""
...
class XLMRSISwingStrategy(BaseStrategy):
    """XLM RSI Mean Reversion Strategy with Limit Orders"""

    def __init__(self, config: Dict[str, Any], symbol: str = 'XLM'):
        super().__init__('xlm_rsi_swing', config, symbol)
