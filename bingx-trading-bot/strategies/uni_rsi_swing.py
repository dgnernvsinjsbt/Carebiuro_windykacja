"""
UNI RSI Swing Strategy - CORRECTED RSI
...
Entry: RSI(14) crosses above 27 (LONG) or below 70 (SHORT)
Limit: 1.5% offset from signal price (wait max 5 bars)
Exit: 1.5x ATR stop loss, 1.0x ATR take profit, or RSI reversal
"""
...
class UNIRSISwingStrategy(BaseStrategy):
    """UNI RSI Mean Reversion Strategy with Limit Orders"""

    def __init__(self, config: Dict[str, Any], symbol: str = 'UNI'):
        super().__init__('uni_rsi_swing', config, symbol)
