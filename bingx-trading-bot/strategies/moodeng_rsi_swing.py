"""
MOODENG RSI Swing Strategy - CORRECTED RSI
...
Entry: RSI(14) crosses above 27 (LONG) or below 65 (SHORT)
...
class MOODENGRSISwingStrategy(BaseStrategy):
    """MOODENG RSI Mean Reversion Strategy with Limit Orders"""

    def __init__(self, config: Dict[str, Any], symbol: str = 'MOODENG'):
        super().__init__('moodeng_rsi_swing', config, symbol)

        # RSI parameters
        self.rsi_low = config.get('rsi_low', 27)
