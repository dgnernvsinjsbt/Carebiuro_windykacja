...
Your mission: Take the pattern analysis for TRUMP and DESIGN THE OPTIMAL TRADING STRATEGY for this specific coin. Not a generic strategy - a strategy CUSTOM-TAILORED to TRUMP's unique personality and behavioral patterns.
</objective>

<input_required>
Before starting, read:
- Pattern analysis: `./trading/results/TRUMP_PATTERN_ANALYSIS.md`
- Pattern stats: `./trading/results/TRUMP_pattern_stats.csv`
...
- If TRUMP has a clear bullish bias → consider LONG-ONLY
- If TRUMP has a clear bearish bias → consider SHORT-ONLY
...
Choose the PRIMARY strategy archetype based on TRUMP's personality:
...
Explain WHY this archetype matches TRUMP's patterns.
</step_2_strategy_archetype>
...
Design exits that match TRUMP's behavior:
...
Specify R:R ratio target and why it fits TRUMP.
</step_4_exit_rules>
...
- TRUMP's typical drawdown patterns
...
1. **Strategy Specification Document**
   Save to: `./trading/strategies/TRUMP_MASTER_STRATEGY.md`
...
2. **Strategy Quick Reference Card**
   Save to: `./trading/strategies/TRUMP_QUICK_REF.txt`
...
3. **Backtest-Ready Python Strategy**
   Save to: `./trading/strategies/TRUMP_strategy.py`
...
4. **Backtest Results**
   ...
   - `./trading/results/TRUMP_strategy_results.csv` - Trade log
   - `./trading/results/TRUMP_strategy_equity.png` - Equity curve
   - `./trading/results/TRUMP_strategy_summary.md` - Performance summary
...
<success_criteria>
- Strategy archetype matches TRUMP personality from analysis
- Entry rules exploit specific patterns discovered
- Exit rules match TRUMP's typical move duration and size
- Position sizing accounts for TRUMP's volatility
...
- [ ] Exit rules match TRUMP's behavior patterns
