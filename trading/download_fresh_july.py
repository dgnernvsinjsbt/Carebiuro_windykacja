"""
Download fresh July 2025 data from BingX API
...
print('=' * 100)
print('DOWNLOADING FRESH JULY 2025 DATA FROM BINGX')
print('=' * 100)

exchange = ccxt.bingx({'enableRateLimit': True})

start = datetime(2025, 7, 1, tzinfo=timezone.utc)
end = datetime(2025, 7, 31, 23, 59, tzinfo=timezone.utc)
...
print(f'\nFiltered to July 2025: {len(df)} bars')
...
# 3. Expected bars in July
july_minutes = (end.replace(tzinfo=None) - start.replace(tzinfo=None)).total_seconds() / 60
expected_bars = int(july_minutes / 15)
...
# Save
filename = 'melania_july_2025_15m_fresh.csv'
df.to_csv(filename, index=False)

print('\n' + '=' * 100)
print('SUMMARY')
print('=' * 100)
print(f'\n✅ Downloaded {len(df)} bars for July 2025')
