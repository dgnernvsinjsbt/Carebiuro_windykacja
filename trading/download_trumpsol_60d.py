#!/usr/bin/env python3
"""Download 60 days of TRUMPSOL 1m data from BingX"""
...
print("=" * 80)
print("DOWNLOADING TRUMPSOL 60-DAY DATA FROM BINGX")
print("=" * 80)
...
def fetch_batch(end_time):
    params = {"symbol": "TRUMPSOL-USDT", "interval": "1m", "endTime": end_time, "limit": 1440}
    try:
...
# Save
output_path = '/workspaces/Carebiuro_windykacja/trading/trumpsol_60d_bingx.csv'
df.to_csv(output_path, index=False)

print(f"\n✅ TRUMPSOL-USDT: {len(df):,} candles in {elapsed:.1f}s")
