#!/usr/bin/env python3
"""Download TRUMP/USDT 1-minute data from MEXC exchange using ccxt"""
...
def download_mexc_data(symbol='TRUMP/USDT', timeframe='1m', days=90):
    """Download historical data from MEXC"""
    ...
    print('=' * 80)
    print(f'Downloading {symbol} {timeframe} data from MEXC')
    ...
    # MEXC allows fetching 1000 candles at a time
    ...
    while current_start < end_time:
        ...
        try:
            ...
            if candles:
                ...
                # Update current_start based on last candle timestamp
                if candles:
                    last_ts = candles[-1][0]
    ...
    # Save to CSV
    filename = 'trump_usdt_1m_mexc.csv'
...
if __name__ == "__main__":
    download_mexc_data(symbol='TRUMP/USDT', timeframe='1m', days=90)
