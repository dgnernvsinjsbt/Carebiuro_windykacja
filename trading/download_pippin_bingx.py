#!/usr/bin/env python3
"""Download PIPPINUSDT 1-minute data from BingX"""
...
# Download maximum available data (new token - likely only few days)
symbol = 'PIPPIN-USDT'
interval = '1m'
end_time = datetime.now()
start_time = end_time - timedelta(days=10)  # Try 10 days to capture all available
...
print('Note: PIPPIN is a new token - actual data may be shorter')
print('=' * 80)
print()
...
if klines:
    ...
    print()
    print("Failed to download data - symbol may not exist or have different name")
    print("Try checking BingX for exact symbol format")