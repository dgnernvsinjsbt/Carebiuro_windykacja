#!/usr/bin/env python3
"""Download ETH/USDT 1-minute data from BingX for Nov 5 - Dec 5, 2025"""
...
# Download 30 days of data (same duration as FARTCOIN)
symbol = 'ETH-USDT'
interval = '1m'
...
if klines:
    ...
    # Reorder columns to match FARTCOIN format
    df = df[['timestamp', 'open', 'high', 'low', 'close', 'volume', 'exchange', 'symbol']]

    # Save to CSV
    filename = 'eth_usdt_1m_bingx.csv'
