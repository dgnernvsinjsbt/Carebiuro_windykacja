#!/usr/bin/env python3
"""Download MOODENG 15m data - 6 months"""
import pandas as pd
import requests
...
print(f"Downloading MOODENG-USDT 15m data from {start_date} to {end_date}")
...
def fetch_batch(end_time):
    params = {"symbol": "MOODENG-USDT", "interval": "15m", "endTime": end_time, "limit": 1440}
    try:
...
filename = 'moodeng_6months_bingx_15m.csv'
