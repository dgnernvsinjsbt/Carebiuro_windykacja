...
def analyze_coin(filename, coin_name):
    ...
    print("="*80)
    print(f"RED vs GREEN DAYS - {coin_name} (Sept - Dec 2025)")
    print("="*80)
    print()
...
# Analyze MELANIA
analyze_coin('melania_6months_bingx.csv', 'MELANIA')

# Analyze PI
analyze_coin('piusdt_6months_bingx_15m.csv', 'PI')
