#!/usr/bin/env python3
"""Download 60 days of FARTCOIN 1m data from BingX"""
...
print("Downloading 60 days of FARTCOIN 1m data from BingX...")
...
print(f"Fetching {num_batches} batches in parallel...")
start = time.time()
...
# Save
output_path = '/workspaces/Carebiuro_windykacja/trading/fartcoin_60d_bingx.csv'
