...
print("="*140)
print("FARTCOIN DAILY RESET STRATEGY - 6 MONTH BREAKDOWN")
print(f"Config: Entry {ENTRY_OFFSET_PCT}% below daily high, SL {SL_PCT}%, TP {TP_PCT}%")
print("="*140)
print()
...
for month in sorted(months):
    ...
    equity = cumulative_equity  # Start from previous month's ending equity
    peak_equity = equity
    max_dd = 0.0
    trades = []
    ...
    cumulative_equity = equity  # Carry forward
