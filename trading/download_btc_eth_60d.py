#!/usr/bin/env python3
"""Download 60 days of BTC and ETH 1m data from BingX"""
...
def download_symbol(symbol):
    ...
    # Calculate batch times (60 days = ~62 batches)
    now = datetime.now()
    num_batches = 62
    ...
    # Save
    output_path = f'/workspaces/Carebiuro_windykacja/trading/{symbol.lower().replace("-", "_")}_60d_bingx.csv'
...
print("=" * 80)
print("DOWNLOADING BTC & ETH 60-DAY DATA")
print("=" * 80)
