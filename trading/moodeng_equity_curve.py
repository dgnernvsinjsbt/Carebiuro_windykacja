#!/usr/bin/env python3
"""Generate equity curve for MOODENG optimized strategy"""
...
print("=" * 80)
print("MOODENG OPTIMIZED STRATEGY - EQUITY CURVE")
print("=" * 80)
...
# Save trades
df_trades.to_csv('results/moodeng_optimized_trades.csv', index=False)
print(f"\n✅ Trades saved to: results/moodeng_optimized_trades.csv")

# Create visualization
fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(14, 10), gridspec_kw={'height_ratios': [3, 1, 1]})
fig.suptitle('MOODENG-USDT Optimized Strategy\nATR 1.4x | EMA 2.0% | TP 6x | SL 1.5x | 60 Days',
             fontsize=16, fontweight='bold')

# Equity Curve
ax1.plot(df_trades['entry_time'], df_trades['equity'], linewidth=2, color='#9C27B0', label='Equity')
ax1.fill_between(df_trades['entry_time'], 100, df_trades['equity'], alpha=0.3, color='#CE93D8')
...
output_path = 'results/moodeng_optimized_equity_curve.png'
