#!/usr/bin/env python3
"""Download ETH/USDT 1-minute data from LBank exchange using ccxt"""
...
def download_lbank_data(symbol='ETH/USDT', timeframe='1m', days=30):
    ...
    # Add exchange and symbol columns to match FARTCOIN format
    df['exchange'] = 'lbank'
    df['symbol'] = symbol
    ...
    # Save to CSV
    filename = 'eth_usdt_1m_lbank.csv'
    ...
    print(f'  Starting: ${df["close"].iloc[0]:.2f}')
    print(f'  Ending: ${df["close"].iloc[-1]:.2f}')
...
if __name__ == "__main__":
    # Download 30 days (same as FARTCOIN)
    download_lbank_data(symbol='ETH/USDT', timeframe='1m', days=30)
