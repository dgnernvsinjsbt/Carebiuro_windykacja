...
print("Downloading ETH-USDT 1h data (90 days)...")
...
def fetch_batch(end_time):
    params = {"symbol": "ETH-USDT", "interval": "1h", "endTime": end_time, "limit": 1440}
    try:
...
output_path = 'eth_1h_90d.csv'
df.to_csv(output_path, index=False)

print(f"✅ ETH-USDT: {len(df):,} candles in {elapsed:.1f}s")
