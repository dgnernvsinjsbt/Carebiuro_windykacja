<objective>
Become the MASTER of a single cryptocurrency. Your mission: exhaustively analyze historical data to discover every exploitable pattern that can form the foundation of a profitable trading strategy.
...
<coin_to_analyze>
$COIN_SYMBOL - Analyze the data file: `./trading/${COIN_FILE}`
...
- Round number effects (psychological levels like $1.00, $0.50, etc.)
...
Create a comprehensive analysis report saved to: `./trading/results/${COIN_SYMBOL}_PATTERN_ANALYSIS.md`
...
8. **Raw Data** - Save key statistics to CSV: `./trading/results/${COIN_SYMBOL}_pattern_stats.csv`
...
Write a Python script that performs this analysis. Save to: `./trading/pattern_discovery_${COIN_SYMBOL}.py`
